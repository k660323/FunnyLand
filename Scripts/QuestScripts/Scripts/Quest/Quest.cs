...
public class Quest : ScriptableObject
{
    ...
    [SerializeField]
    private bool isDonCompletListAdd;
    [SerializeField]
    ...
    public bool IsRegisteed => State != QuestState.Inactive;

    public bool IsDonCompletListAdd => !isSavable && isDonCompletListAdd;
    ...
    public virtual bool IsSaveable => isSavable;
    ...
    {
        Debug.Assert(!IsRegisteed, "This quest has already been registered.");
